...
# **Getting the data**
## Load the [data](https://d396qusza40orc.cloudfront.net/dsscapstone/dataset/Coursera-SwiftKey.zip)
...
## Remove URLs,emojis,non-english words,punctuations,numbers,whitespace, stop words and [profanity](https://github.com/whomwah/language-timothy/blob/master/profanity-list.txt).
```{r, results='hide'}
